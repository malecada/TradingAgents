...
spec=importlib.util.spec_from_file_location('release_bootstrap_test',ROOT/'scripts/options_release_bootstrap.py')
...
def bundle(tmp_path):
    ...
    for name in b.FILES:
        ...
        body=(ROOT/'scripts/options_release_bootstrap.py').read_bytes() if name=='release_bootstrap.py' else b'# synthetic source\n'
