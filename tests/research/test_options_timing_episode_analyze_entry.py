"""Actual target entry on a disposable20-history fixture; no market/economics."""
from datetime import datetime,timezone
import importlib.util
import json
from pathlib import Path
import pytest
from tests.research.test_options_timing_control import build_fixture,start,write,ref,commit,rebind
...
from tradingagents.research_options_timing import analysis,control

spec=importlib.util.spec_from_file_location('options_episode_entry_test',Path(__file__).resolve().parents[2]/'scripts/options_timing_episode_analyze.py')
