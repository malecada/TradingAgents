...
Current branch: `fix/factor-floor-correction-2026-09-10`. The separately registered18-cell factor correction is complete on source2764088:90fixed paired evaluations,16improved and7positive primary development Sharpes; all36coin sleeves ultimately halt. TSMOM30LS SR3650.280→0.985, doubled-cost0.907. All18old scalar summaries and the saved BEST stream reproduce; inputs remain qualified spot proxies with assumed funding. No strategy validation or new BEST selection. See docs/factor-correction/FACTOR_CORRECTION_2026-09-10.md and Section95.
