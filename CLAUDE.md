...
Current branch: `research/dated-carry-feasibility-2026-09-10`. The user paused after a memory checkpoint. Read `docs/SESSION_HANDOFF_2026-09-10.md` first; research-results commit `52508ea` is pushed. Objective: positive net returns with little crypto-price exposure, approximately $1,000 initially and possibly $10,000, Binance and possibly Bitrue.

The fixed current dated-carry measurement is complete: all48 entry cases and432 terminal scenarios retained; all432 modeled cash profits negative under registered fee assumptions, allfour screens fail. The accounting example and127 pre-result tests plus independent saved reconstruction are complete. Original financial ledger remains820rows; no strategy evaluation, paper start or automatic quote refresh is pending. See `docs/carry-feasibility-2026-09-10/INTERPRETATION.md` and Section98. Actual fees/settlement applicability, account access, spot freshness and pathwise margin remain qualified. Zero validated strategies.

The saved forecast/risk diagnostics and72-case sizing/stop comparison are complete (Sections96–97). Daily sizing fixes nominal risk drift; waiting improves14/18 historical indices but half are smaller near-idle long-only losses. Four long/short configurations turn positive across four cost assumptions, with no selected champion, adoption gate or fresh validation. Preserve the spent history.

Previous factor correction branch: `fix/factor-floor-correction-2026-09-10`. The separately registered18-cell factor correction is complete on source2764088:90fixed paired evaluations,16improved and7positive primary development Sharpes; all36coin sleeves ultimately halt. TSMOM30LS SR3650.280→0.985, doubled-cost0.907. All18old scalar summaries and the saved BEST stream reproduce; inputs remain qualified spot proxies with assumed funding. No strategy validation or new BEST selection. See docs/factor-correction/FACTOR_CORRECTION_2026-09-10.md and Section95.

Previous engineering branch: `fix/prospective-funding-capture-2026-09-10`. Public funding capture and optional paired paper admission are implemented on source `7d2a0ae9ef4ad707774360d2f67af40258a7d2e3`; 584 integrated Python tests passed. Raw event timestamps and exact Unicode identities are preserved. The prospective one-second comparison-label policy is separate from the unchanged legacy loader; missing cadence/quotes/state produces WAIT before either paper append. See `docs/funding-capture/FUNDING_CAPTURE_2026-09-10.md` and Section 94. The prepared archive has not been uploaded or deployed; no paper accumulation, financial replay or ledger append occurred.
