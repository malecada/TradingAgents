...
- Canonical evidence: `AUDIT_SYSTEM_2026-09-09.md`, `AUDIT_REPAIRS_2026-09-09.md`, `REEVALUATION_LEADS_2026-09-09.md`, and the audit-fixes correction register. Both September 9 registered cycles are complete. The second evaluated 26 fixed cases: **21 accounting cases are unavailable, three liquidation-fade cases fail, PRX fails its conditional comparison with incomplete pair coverage, and NLST4 passes ranking T1 but fails economics T2.** Do not count the 21 unavailable cases as confirmed kills. NLST4 IC=0.14236 is a qualified descriptive result on 2,718/2,776 scoreable new pools; its global-quintile economics remain retrospective. Details: THESIS_FINDINGS §89.
- Immediate recovery requirements: verified perpetual contract settlement events for BZRX/BNX/LUNA, internal TRX/FIL/LTC hourly gaps in February/April 2022, and PRX contract-identity coverage. No substitute price, ticker rename, shortened sample or repeated legacy main is authorized by a missing-data result. Any further empirical correction requires a new committed registration; existing holdout spending is preserved.
...
| `TradingAgents-audit-fixes/` | consolidated correction and reevaluation branch (`research/audit-reevaluation-2026-09-09`) | active engineering |
...
- `REEVALUATION_LEADS_2026-09-09.md` — all 26 fixed corrections, unavailable-data reasons, measured failures and qualified NLST4 ranking
