...
|---|---|
| September 24 paper-faithful transaction-graph replication | [Study state](../../research/onchain-paper-replication-2026-09-24/STATE.md), [result checkpoint](../../research/onchain-paper-replication-2026-09-24/RESULT.md) and [independent review](../../research/onchain-paper-replication-2026-09-24/IMPLEMENTATION_REVIEW.md). Full motif/MCM/GAT/attention-LSTM core is synthetically verified; BTC/ETH2016–2024 prices captured under explicit Coin Metrics substitution. Resource pilot02 failed under systemd-oomd pressure; full scope, financial fits and numerical agreement remain incomplete. Earlier negative summary screen is separate and unchanged. |
