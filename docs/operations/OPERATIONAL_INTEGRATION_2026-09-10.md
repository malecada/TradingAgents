...
The prepared local source archive contains 284 files (1,111,122 compressed bytes), pinned to source commit `4ce0101f7bfdcc3eb8a141334c9786bafe9e0aa6`. Its checksum and positive allowlist are recorded in `verification/release-package.json`. It includes the new helper and rebuilt frontend, excludes research data and secrets, and has not been uploaded or deployed.
