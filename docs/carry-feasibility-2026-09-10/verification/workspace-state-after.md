...
- **Dated BTC/ETH carry feasibility is complete and negative at the observed quotes** (`dated_carry_feasibility_2026_09_10`, registration `57149c6`, source `62bcf8b`). The user prioritizes positive net returns with little crypto-price exposure, initially approximately $1,000 and potentially $10,000, on Binance and possibly Bitrue. The single public capture retained 16 requests, three snapshots, 48 entry cases and 432 complete terminal scenarios for BTCUSDT_260925 / ETHUSDT_260925. All 432 modeled net cash outcomes are negative under the frozen fee assumptions; none of the four asset/capital necessary screens passes. Base/full-reserve/flat-index/no-mismatch cash ranges are BTC −0.58 to −0.55 / ETH −0.90 to −0.80 USDT at 1,000, and BTC −6.49 to −6.05 / ETH −9.90 to −8.26 at 10,000. Fees, account applicability, spot freshness and margin survival remain conditional. All 72 one-third-reserve / doubled-index cells have terminal reserve shortfalls. Synthetic accounting and independent reconstruction passed after 127 pre-result tests; the 820-row financial ledger is unchanged. Steps 1–2 are complete; a strategy evaluation and paper start are not justified by this measurement. No automatic quote refresh is pending; any further empirical cycle needs a new question/registration. Bitrue dated availability remains unverified. See `TradingAgents-audit-fixes/docs/carry-feasibility-2026-09-10/INTERPRETATION.md`, THESIS_FINDINGS §98. **Zero validated strategies.**
...
| `TradingAgents-audit-fixes/` | consolidated correction and reevaluation branch (`research/dated-carry-feasibility-2026-09-10`) | active engineering |
