...
class ResearchRun:
    ...
    def start(cls, *, root, registration, experiment, source, design_source=None, bindings=None):
        ...
        with _lock(admitted.root):
            ...
            if admitted.extension is not None:
                claim["budget_book_grant"] = admitted.extension
    ...
    def _check_source(self):
        ...
        if current.extension != self.admission.extension:
            raise ValueError("extension changed during run")
