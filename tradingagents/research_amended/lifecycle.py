...
class ResearchRun:
    ...
    def start(cls, *, root, registration, experiment, source, design_source=None, bindings=None):
        ...
        with _lock(admitted.root):
            ...
            if admitted.amendment is not None:
                claim["budget_amendment"] = admitted.amendment
    ...
    def _check_source(self):
        ...
        if current.amendment != self.admission.amendment:
            raise ValueError("amendment changed during run")
