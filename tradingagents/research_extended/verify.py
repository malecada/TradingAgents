...
def verify_claim(directory) -> dict:
    ...
    from .verify_v1_snapshot import check as check_v1
    from .verify_extension import check
...
def verify_run(directory) -> dict:
    ...
    return {"experiment": claim["experiment_id"], "status": status, "cell_count": count,
            ...
            "verification": "structural hashes and denominators; v1 amendments at closed inventory, current extensions against complete live inventory; no scientific validation"}
