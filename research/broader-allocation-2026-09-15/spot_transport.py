"""Frozen spot-source GET adaptation; no account/transaction endpoints."""
import http.client
import signal
import urllib.error
import urllib.parse
...
def public_get(url):
    ...
    """
    if url not in {'https://api.binance.com/api/v3/depth?symbol=ETHUSDC&limit=100', 'https://api.binance.com/api/v3/depth?symbol=BTCUSDC&limit=100', 'https://api.binance.com/api/v3/exchangeInfo?symbols=%5B%22BTCUSDC%22%2C%22ETHUSDC%22%5D', 'https://api.binance.com/api/v3/time'}:
    ...
    try:
        ...
        request = urllib.request.Request(url, headers={"Accept": "application/json",
                                         "User-Agent": "RegisteredSpotSourceResearch/1.0"})
        try:
