"""Frozen historical source GET adaptation; no account/transaction endpoints."""
import http.client
import signal
import urllib.error
import urllib.parse
...
def _deadline(signum, frame):
    raise TimeoutError("10-second request wall deadline")
...
def public_get(url):
    ...
    """
    if url not in {'https://api.binance.com/api/v3/klines?symbol=ETHUSDC&interval=1d&startTime=1739404800000&endTime=1788220800000&limit=1000', 'https://api.kraken.com/0/public/AssetPairs?pair=USDCUSD', 'https://api.kraken.com/0/public/OHLC?pair=USDCUSD&interval=1440&since=1739404800', 'https://api.binance.com/api/v3/klines?symbol=BTCUSDC&interval=1d&startTime=1739404800000&endTime=1788220800000&limit=1000'}:
    ...
    try:
        ...
        request = urllib.request.Request(url, headers={"Accept": "application/json",
                                         "User-Agent": "RegisteredHistoricalReadiness/1.0"})
        try:
