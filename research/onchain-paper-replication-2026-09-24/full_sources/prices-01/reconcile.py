...
def reconcile(receipt,artifacts,source,owner_identity,asset):
    if asset not in ('BTC','ETH') or owner_identity.get('asset')!=asset:raise ValueError('observer asset differs')
