...
### Independent compact checkpoint04 external recovery verification

The two preparation safeguards were independently reread: every Git command,
including initial HEAD resolution and the cat-file subprocess, receives
GIT_NO_LAZY_FETCH=1; each blob size is compared with the remaining 128 MiB
allowance before allocation, with subprocess termination on rejection. These
findings are closed. The review itself used only local Git objects with lazy
fetching disabled and made no request or financial computation.

The recovered manifest and archive under
/tmp/onchain-paper-preparation-recovery-20260924-04 match the two pinned HTTP
receipt URLs, byte sizes and hashes at publication commit
7aa1c0ca7e5df42113b29ea55d77b244859d131c. Archive 2888745 bytes, SHA256
7d404c85a374bcd1a69601ecf794ca302faa342e1def9fd82d0ef7ecafbf9497;
manifest 1615766 bytes, SHA256
c23dcd5e0df0b0926ea40f54fd07d4cd7f0500843252c42badbc62f28cd2e83b.
All 6653 unique regular tar members (12981017 uncompressed bytes) were hashed
against the recovered manifest and compared byte-for-byte with local Git blobs
at snapshot 2e7e3c51cf54b20b278f2d9f0220782786125a61. The base
f45ffecafec136db14c8214208690110b82dc216-to-snapshot Git diff has exactly those
added/modified members and no unrepresented deletion or rename. No archive was
extracted and no broad clone or Git archive operation was used.

Both preserved Coin Metrics terminals retain their previously reviewed hashes:
BTC 2e34319ed8173e702c54e736efeda94c8c26ccece738026d3016e4903ed926fe;
ETH 5f73ee1f0a8028fa11c54e53ba56c9e45c7fe8b08e520fdf68f150355331ffc4.
Each has exactly 3289 unique complete cells and zero unavailable cells. Every
terminal output hash and every source artifact-index hash matches an archived
member, including the 2482497-byte BTC and 2121732-byte ETH raw response.bin
files and derived price panels. The retained ATTRIBUTION.md names Coin Metrics,
the pinned source revision, the CC BY-NC 4.0 license link and the transformations;
it distinguishes that data license from implementation and article attribution.
This verifies preservation of the already reviewed source outcomes, not a new
price admission or empirical prediction result.

Recovery-completion SHA256
1c72f233457a5ca1b31b3e4ad55092b7f902852eaafd6bd9e88f83b4854bc99f
records exactly two successful HTTP members and 4504511 transferred bytes.
Guard SHA256 d8ef6b68bf6158ed832bbcfff7b29000f9678f6a8c1ad4be237a808cd2ade23b
records child zero, verified cleanup, no memory events or triggered limit,
1.937645814 seconds and a 32034816-byte sampled peak. Its cgroup and monitor
PID are absent. Active HEAD remains c6b568d4b1c177ab94ac37fbad462c2decc721c0.
No active pilot artifact is included in this delta. Recovery is complete for
this compact checkpoint plus its separately recovered base chain; full raw
transaction backup, real raw-to-prediction replay and overall study completion
remain unverified. Later state/report edits are outside these immutable bytes.


### Independent pilot02 terminal, preservation and cause review

The closed resource attempt eth-paper-resource-pilot-20260924-02 is failed,
not a successful resource pilot. Before any HEAD movement, all 26 registered
source files, 88 inputs, six research-lifecycle runtime files and the registration
hash were independently matched to its claim at source
c6b568d4b1c177ab94ac37fbad462c2decc721c0. The failed terminal binds the exact
claim SHA256 05d769f6f50a65c2cf3eeed569077eb84e3871b1e7c23ad3504eed461a0565ca;
there is no contradictory complete terminal. Guard owner identity equals the
immutable monitor record, whose nonce/supervisor/source agree with owner.json.
Observer hashes match the guard files, artifact index, terminal and cell ledger.
The current boot matches the receipt; supervisor, monitor, wrapper, orchestration
and last worker PIDs are absent; the cgroup is absent and the local unit reports
MainPID=0 and an empty ControlGroup. No terminal identity was reopened.

The postmortem ledger contains exactly the 109 unique registered IDs: seven
complete and 102 unavailable. Completed stages are two whole-week graphs, two
512-sample neighborhood sets, two matching probes and the first-week 32-motif
dictionary. Four unavailable dispositions retain explicit capacity errors:
two full-node MCM attempts exceeded the frozen 10000-node neighborhood bound
without truncation, and two neural phases refused preregistered intermediate
estimates above the 1 GiB working allowance. The other 98 dispositions record
interruption before a durable cell disposition. The 2022-07-25 largest-week
decode has an intent and preserved SQLite scratch, but no durable graph result.
Its partial state does not establish a completed graph. No neural forward or
full MCM completion is inferred from these artifacts.

Source-day finalization is at the end of run.py: all 63 source-day ledger cells
therefore remain conservatively unavailable after the interrupted workload,
although completed graph receipts establish decoding of the first two seven-day
weeks. The ledger must remain immutable; supplemental exposure reporting should
distinguish those 14 decoded days and the interrupted third-week attempt from
untouched downstream work. In particular, “98 unavailable” must not become
“98 never attempted,” nor imply that already decoded windows are fresh.

The failure cause was independently obtained from the scoped local journal,
not inferred from a zero kernel counter. At 2026-09-24T15:28:59Z,
systemd-oomd killed this exact unit because user@1000.service ancestor full
memory pressure was 51.89 percent, above 50 percent for over 20 seconds with
reclaim activity. The unit journal reports eight processes killed and main
status 9/KILL. Guard final SHA256
572cd9d941be58f0fa36a749c98423c93e05a68a23376b6b7b2cad0248df6b6d
retains Result=signal, failed phase, 10247.693756140 seconds, 2783363072-byte
sampled peak and 231224 memory.high events; kernel oom/oom_kill remain zero.
Those zero counters do not mean that no memory-related kill occurred. The
empirical pilot readback remains exactly 3 GiB maximum, 2.5 GiB high, zero swap,
two-CPU affinity and the registered reserves. Its measured
failure concerns this host and resource contract, not intrinsic infeasibility
of the paper architecture. Further resource execution needs a separately
reviewed feasible contract; no retry is released by this review.

The closure bundle's 52 compact members (2054170 bytes) and both journal hashes
were independently checked against retained copies and originals. All 69
postmortem artifact-index files exist with matching sizes. Initially 52 compact
hashes were checked; under the parent's separate bounded verification request,
one new hash-audit-01 streamed the remaining 17 files (5305932810 bytes) without
NumPy/SQLite decoding, raw-data reinterpretation or financial computation.
Every hash matched its closed index. Immutable per-file receipts and the
contract preserve this verification. The audit used read-only file descriptors,
1 MiB chunks, file-stat identity checks and advisory release of read pages.
Its enforced limits were 512 MiB maximum/384 MiB high/zero swap, two CPUs,
3 GiB runtime reserve, 3.5 GiB startup reserve, 20 GiB disk floor and 900 seconds.
The audit guard completed in 12.741396375 seconds at 87760896-byte sampled peak,
child zero, no memory events, no limit and verified cleanup; its cgroup is absent.
Audit completion SHA256
ce425cef169884e7615a773bcf97cf6687fd2f2d57ce33090f4e2ae51ae957b8;
audit guard SHA256
a9f24592517d348739cafafea1c44b2d1b7311c4c1163507294eb4bf21c6b276.

Pilot terminal SHA256
3d318717ff7adecb0f07b9db6f3d1bd2e24e0c77705c3e07062cd4b075f8d7f2
and postmortem ledger SHA256
09750888389e7bba366818aa4134ae07e72f6fdeeb4af59594e7f0f627cc3e5c
are closed evidence. Seven exact-family new claims plus 17 prior attempts
remain 24 consumed of the cumulative 51; closing this failure does not refund
an attempt or constitute a new financial fit. There is no critical unexplained
failure, missing-denominator or orphan finding preventing preservation of this
closed attempt in a normal source/evidence commit. This closes its failure-cause
