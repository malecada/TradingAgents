...
if __name__=='__main__':
    ...
    ownership=receipt.parent/'pilot-01-supervisor'
    ...
    if receipt.exists():raise FileExistsError('pilot identity already attempted; never relaunch')
    ...
    result=module.reconcile(receipt,receipt.parent/'pilot-01',source,identity)
