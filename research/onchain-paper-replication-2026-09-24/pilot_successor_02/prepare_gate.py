...
def main():
    ...
    paths.extend([STUDY/'protocol-freeze-v4.json',STUDY/'resource-cap-v4.md',HERE/'resource-contract-v4.json',HERE/'budget-allocation.proposed.json',ROOT/'research_runs/eth-paper-resource-pilot-20260924/claim.json',ROOT/'research_runs/eth-paper-resource-pilot-20260924/failed.json'])
