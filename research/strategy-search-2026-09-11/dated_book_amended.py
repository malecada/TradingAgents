"""One explicitly amended dated attempt; immutable economic code and inputs."""
import argparse
import json
...
def main():
    ...
    with ResearchRun.start(root=Path(__file__).resolve().parents[2],
            registration='research/strategy-search-2026-09-11/gates-dated-amended.json',
            experiment='dated-book-amended-20260911', source=args.source) as run:
