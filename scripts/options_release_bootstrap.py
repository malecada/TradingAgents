...
FILES={f'tradingagents/research_options_capture/{n}.py' for n in ('journal','transport','schedule','worker','adapter')}
...
def main():
    ...
    runpy.run_module('tradingagents.research_options_capture.worker',run_name='__main__')
